...
grid = []
input_grid = """89 90 95 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
def main():
    ...
    i_grid = input_grid.strip().split('\n') 
    for row in i_grid:
        grid.append([int(grid_temp) for grid_temp in row.split(' ')])
